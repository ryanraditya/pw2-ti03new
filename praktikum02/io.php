...
<form class="form-horizontal">
  <div class="form-group">
    <label for="text" class="control-label col-xs-6">Text Field</label> 
    <div class="col-xs-6">
  ...
  <div class="form-group">
    <label for="text1" class="control-label col-xs-6">Jumlah</label> 
    <div class="col-xs-6">
      <input id="text1" name="text1" type="text" aria-describedby="text1HelpBlock" class="form-control"> 
      <span id="text1HelpBlock" class="help-block">jj</span>
    </div>
  </div> 
  <div class="form-group row">

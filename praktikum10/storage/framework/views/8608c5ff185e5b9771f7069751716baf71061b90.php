    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/adminlte.min.css')); ?>">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="" class="nav-link">Periksa</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <!-- /.navbar --><?php /**PATH C:\xampp\htdocs\PW2-TI03\praktikum10\pw2-ti03-master\resources\views/ryan/partials/header.blade.php ENDPATH**/ ?>